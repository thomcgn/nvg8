                ...
                <div className="mx-auto w-full max-w-4xl px-3 sm:px-6 pb-12 pt-4 space-y-4">
                    ...
                    <div className="flex items-center justify-between gap-3">
                        ...
                        <Button
                            className="gap-2"
                            onClick={() =>
                                router.push(`/dashboard/falloeffnungen/${fid}/schutzplaene/neu`)
                            }
                        >
                            ...
                            <CardContent className="py-8 text-center text-sm text-brand-text2">
                                ...
                                <div className="mt-3">
                                    <Button
                                        onClick={() =>
                                            router.push(
                                                `/dashboard/falloeffnungen/${fid}/schutzplaene/neu`
                                            )
                                        }
                                        className="gap-2"
                                    >
                    ...
                    <div className="space-y-3">
                        {items.map((item) => (
                            <SchutzplanCard
                                ...
                                onClick={() =>
                                    router.push(
                                        `/dashboard/falloeffnungen/${fid}/schutzplaene/${item.id}`
                                    )
                                }
                            />
                        ))}
