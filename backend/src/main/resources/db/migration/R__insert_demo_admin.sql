...
DELETE FROM kinder
WHERE traeger_id = (SELECT id FROM traeger WHERE slug = 'demo-traeger');

DELETE FROM bezugspersonen
WHERE traeger_id = (SELECT id FROM traeger WHERE slug = 'demo-traeger');

DELETE FROM user_org_roles
WHERE user_id IN (SELECT id FROM users WHERE email IN ('demo@kidoc.local','admin@kidoc.io'));

DELETE FROM users
WHERE email IN ('demo@kidoc.local','admin@kidoc.io');

DELETE FROM org_units
WHERE traeger_id = (SELECT id FROM traeger WHERE slug = 'demo-traeger');

DELETE FROM traeger
WHERE slug = 'demo-traeger';
