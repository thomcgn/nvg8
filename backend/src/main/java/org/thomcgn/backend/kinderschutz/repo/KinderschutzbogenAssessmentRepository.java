...
public interface KinderschutzbogenAssessmentRepository extends JpaRepository<KinderschutzbogenAssessment, Long> {

    @Query("""
        select a from KinderschutzbogenAssessment a
    ...
    """)
    Optional<KinderschutzbogenAssessment> findByIdScoped(
            @Param("id") Long id,
    ...
    """)
    List<KinderschutzbogenAssessment> findByFalloeffnungScoped(
