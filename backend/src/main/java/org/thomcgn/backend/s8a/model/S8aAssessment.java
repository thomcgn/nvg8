...
/**
 * Strukturierte fachliche Einschätzung (§8a) pro Vorgang.
 *
 * Beteiligte sind NICHT in dieser Tabelle gespeichert,
 * sondern relational in S8aAssessmentParticipant (Snapshot pro Version).
 */
@Entity
@Table(
